export const enviroment = {
    urlOfMatchList: 'https://barracks.sa.nexon.com/api/ClanHome/GetClanMatchList/',
    clienIds: [
    'sladltlek', 'ljslove', 'LOTUS', 'dregonlif', 'hweeparam', 'clanhanul','knonkoutkikiki'
    // 'SkullClanz','you7501', 
    ...
    // 'NumberMatch', 'pookoo', , 'HardBotrio', 'roma', 'meein', 'sinzo123', 'noneplus', 'pandemic', 'dkssud13'
    ],
    clanNames: [
        'NeGlecT-','Xperia','-Ballantine_s_M-','izmir-',`'Signal'`,'Asterisk','Entertainment、','decalcomanie:)','legend1st',
